...
const SPRINTS: Sprint[] = [
  ...
  },
  {
    ...
    status: 'done',
    items: [
      { label: 'HealthKit integration (steps, HR, sleep, BP, glucose, weight)', status: 'done' },
      { label: 'Health dashboard with trend cards', status: 'done' },
      { label: 'Manual logging (mood, meals, water, weight)', status: 'done' },
      { label: 'iOS Widgets (Home Screen + Lock Screen)', status: 'done' },
      { label: 'Push notifications (reminders)', status: 'done' },
      { label: 'Face ID / biometrics', status: 'done' },
      { label: 'Haptic feedback', status: 'done' },
      { label: 'Sync to Supabase', status: 'done' },
      { label: 'Sync to GitHub (life-os repo)', status: 'done' },
    ],
  },
  {
    number: 3,
    ...
    status: 'active',
    items: [
      { label: 'Dynamic Island (live step count, AI status)', status: 'done' },
      { label: 'Live Activities on Lock Screen', status: 'done' },
      { label: 'Action Button (quick Claude chat)', status: 'upcoming' },
      { label: 'Background health sync', status: 'done' },
    ],
  },
  {
    number: 4,
  ...
  },
  {
    ...
    status: 'active',
    items: [
      { label: 'Conversation history', status: 'done' },
      { label: 'Voice input', status: 'done' },
